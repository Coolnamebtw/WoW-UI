...
$Revision: 2594 $
$Date: 2020-05-28 23:29:26 +1000 (Thu, 28 May 2020) $
	...
	path.args = {
		...
		general = {
			...
			args = {
						...
						auto_open = {
							...
							args = {
								...
								bank = {
									...
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_OPEN_TEXT"], ArkInventory.Localise["CONFIG_AUTO_BANK"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
								...
								vault = {
									...
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_OPEN_TEXT"], ArkInventory.Localise["CONFIG_AUTO_VAULT"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"] }
										return t
									end,
								...
								mail = {
									...
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_OPEN_TEXT"], ArkInventory.Localise["CONFIG_AUTO_MAILBOX"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"] }
										return t
									end,
								...
								merchant = {
									...
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_OPEN_TEXT"], ArkInventory.Localise["CONFIG_AUTO_MERCHANT"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"] }
										return t
									end,
								...
								trade = {
									...
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_OPEN_TEXT"], ArkInventory.Localise["CONFIG_AUTO_TRADE"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"] }
										return t
									end,
								...
								auction = {
									...
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_OPEN_TEXT"], ArkInventory.Localise["CONFIG_AUTO_AUCTION"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"] }
										return t
									end,
								...
								void = {
									...
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_OPEN_TEXT"], ArkInventory.Localise["CONFIG_AUTO_VOID"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"] }
										return t
									end,
								...
								scrap = {
									...
									disabled = not ArkInventory.ClientCheck( WOW_PROJECT_MAINLINE ),
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_OPEN_TEXT"], ArkInventory.Localise["CONFIG_AUTO_SCRAP"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"] }
										return t
									end,
								...
								transmog = {
									...
									disabled = not ArkInventory.ClientCheck( WOW_PROJECT_MAINLINE ),
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_OPEN_TEXT"], ArkInventory.Localise["CONFIG_AUTO_TRANSMOG"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"] }
										return t
									end,
						...
						auto_close = {
							...
							args = {
								...
								bank = {
									...
									name = ArkInventory.Localise["CONFIG_AUTO_BANK"],
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_TEXT"], ArkInventory.Localise["CONFIG_AUTO_BANK"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"], ArkInventory.Localise["ALWAYS"] ),
									values = function( )
								...
								vault = {
									...
									disabled = not ArkInventory.ClientCheck( ArkInventory.Global.Location[ArkInventory.Const.Location.Vault].proj ),
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_TEXT"], ArkInventory.Localise["CONFIG_AUTO_VAULT"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"], ArkInventory.Localise["ALWAYS"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"], [2] = ArkInventory.Localise["ALWAYS"] }
										return t
									end,
								...
								mail = {
									...
									name = ArkInventory.Localise["CONFIG_AUTO_MAILBOX"],
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_TEXT"], ArkInventory.Localise["CONFIG_AUTO_MAILBOX"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"], ArkInventory.Localise["ALWAYS"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"], [2] = ArkInventory.Localise["ALWAYS"] }
										return t
									end,
								...
								merchant = {
									...
									name = ArkInventory.Localise["CONFIG_AUTO_MERCHANT"],
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_TEXT"], ArkInventory.Localise["CONFIG_AUTO_MERCHANT"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"], ArkInventory.Localise["ALWAYS"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"], [2] = ArkInventory.Localise["ALWAYS"] }
										return t
									end,
								...
								trade = {
									...
									name = ArkInventory.Localise["CONFIG_AUTO_TRADE"],
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_TEXT"], ArkInventory.Localise["CONFIG_AUTO_TRADE"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"], ArkInventory.Localise["ALWAYS"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"], [2] = ArkInventory.Localise["ALWAYS"] }
										return t
									end,
								...
								auction = {
									...
									name = ArkInventory.Localise["CONFIG_AUTO_AUCTION"],
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_TEXT"], ArkInventory.Localise["CONFIG_AUTO_AUCTION"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"], ArkInventory.Localise["ALWAYS"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"], [2] = ArkInventory.Localise["ALWAYS"] }
										return t
									end,
								...
								void = {
									...
									disabled = not ArkInventory.ClientCheck( ArkInventory.Global.Location[ArkInventory.Const.Location.Void].proj ),
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_TEXT"], ArkInventory.Localise["CONFIG_AUTO_VOID"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"], ArkInventory.Localise["ALWAYS"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"], [2] = ArkInventory.Localise["ALWAYS"] }
										return t
									end,
								...
								scrap = {
									...
									disabled = not ArkInventory.ClientCheck( WOW_PROJECT_MAINLINE ),
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_TEXT"], ArkInventory.Localise["CONFIG_AUTO_SCRAP"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"], ArkInventory.Localise["ALWAYS"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"], [2] = ArkInventory.Localise["ALWAYS"] }
										return t
									end,
								...
								transmog = {
									...
									disabled = not ArkInventory.ClientCheck( WOW_PROJECT_MAINLINE ),
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_TEXT"], ArkInventory.Localise["CONFIG_AUTO_TRANSMOG"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"], ArkInventory.Localise["ALWAYS"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"], [2] = ArkInventory.Localise["ALWAYS"] }
										return t
									end,
								...
								combat = {
									...
									type = "select",
									desc = string.format( ArkInventory.Localise["CONFIG_AUTO_CLOSE_COMBAT_TEXT"], ArkInventory.Localise["CONFIG_AUTO_COMBAT"], ArkInventory.Localise["BACKPACK"], ArkInventory.Localise["NO"], ArkInventory.Localise["YES"] ),
									values = function( )
										local t = { [0] = ArkInventory.Localise["NO"], [1] = ArkInventory.Localise["YES"] }
										return t
									end,
						...
						itemcount = {
							...
							args = {
								enable = {
									order = 100,
									name = ArkInventory.Localise["ENABLED"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ENABLE_TEXT"],
									type = "toggle",
									get = function( info )
								...
								colour_class = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_CLASS_TEXT"],
									type = "toggle",
									disabled = function( info )
								...
								colour_text = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT_TEXT"],
									type = "color",
									hasAlpha = false,
									disabled = function( )
										return not ArkInventory.db.option.tooltip.show or not ArkInventory.db.option.tooltip.itemcount.enable
								...
								colour_count = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_AMOUNTS_TEXT"],
									type = "color",
									hasAlpha = false,
									disabled = function( )
										return not ArkInventory.db.option.tooltip.show or not ArkInventory.db.option.tooltip.itemcount.enable
								...
								account = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ACCOUNT_ONLY_TEXT"],
									type = "toggle",
									disabled = function( )
						...
						money = {
							...
							args = {
								enable = {
									order = 100,
									name = ArkInventory.Localise["ENABLED"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_MONEY_ENABLE_TEXT"],
									type = "toggle",
									get = function( info )
								...
								colour_class = {
									order = 200,
									name = ArkInventory.Localise["CLASS_COLOURS"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_MONEY_COLOUR_CLASS_TEXT"],
									type = "toggle",
									disabled = function( info )
								...
								colour_text = {
									order = 210,
									name = ArkInventory.Localise["TEXT"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_MONEY_COLOUR_TEXT_TEXT"],
									type = "color",
									hasAlpha = false,
									disabled = function( )
										return not ArkInventory.db.option.tooltip.show or not ArkInventory.db.option.tooltip.money.enable
								...
								colour_count = {
									order = 220,
									name = ArkInventory.Localise["AMOUNTS"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_MONEY_COLOUR_AMOUNTS_TEXT"],
									type = "color",
									hasAlpha = false,
									disabled = function( )
										return not ArkInventory.db.option.tooltip.show or not ArkInventory.db.option.tooltip.money.enable
				...
				junk = {
					...
					args = {
						...
						raritycutoff = {
							...
							desc = function( info )
								return string.format( ArkInventory.Localise["CONFIG_JUNK_QUALITY_CUTOFF_TEXT"], ( select( 5, ArkInventory.GetItemQualityColor( ArkInventory.db.option.junk.raritycutoff ) ) ), _G[string.format( "ITEM_QUALITY%d_DESC", ArkInventory.db.option.junk.raritycutoff or LE_ITEM_QUALITY_POOR )] )
							end,
							type = "select",
							disabled = function( info )
								return not ArkInventory.db.option.junk.sell
						...
						count = {
							...
							args = {
								count = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_BONUSID_SUFFIX_COUNT_TEXT"],
									type = "toggle",
									get = function( info )
						...
						search = {
							...
							args = {
								suffix = {
									order = 100,
									name = ArkInventory.Localise["CONFIG_GENERAL_BONUSID_SUFFIX"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_BONUSID_SUFFIX_SEARCH_TEXT"],
									type = "toggle",
									get = function( info )
								...
								corruption = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_BONUSID_CORRUPTION_SEARCH_TEXT"],
									type = "toggle",
									get = function( info )
				...
				profession = {
					order = 1000,
					name = ArkInventory.Localise["PROFESSIONS"],
					type = "group",
					args = {
						priority = {
							order = 100,
							name = ArkInventory.Localise["CONFIG_GENERAL_PROFESSION_PRIORITY"],
							desc = ArkInventory.Localise["CONFIG_GENERAL_PROFESSION_PRIORITY_TEXT"],
							type = "select",
							...
							get = function( info )
								local codex = ArkInventory.GetPlayerCodex( )
								return codex.player.data.priority.profession
							end,
							set = function( info, v )
								local codex = ArkInventory.GetPlayerCodex( )
								codex.player.data.priority.profession = v
								ArkInventory.ItemCacheClear( )
				...
				threads = {
					...
					args = {
						...
						timeout_normal = {
							...
							desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_TEXT"], string.lower( ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_NORMAL"] ) ),
							type = "range",
							min = 25,
							max = 5000,
							step = 5,
						...
						timeout_combat = {
							...
							desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_TEXT"], string.lower( ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_COMBAT"] ) ),
							type = "range",
							min = 25,
							max = 250,
							step = 5,
						...
						timeout_tooltip = {
							...
							desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_TEXT"], string.lower( ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_TOOLTIP"] ) ),
							type = "range",
							min = 25,
							max = 5000,
							step = 5,
						...
						restack = {
							...
							args = {
								bag = {
									...
									desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_RESTACK_TEXT"], ArkInventory.Global.Location[ArkInventory.Const.Location.Bag].Name ),
									type = "toggle",
									get = function( info )
								...
								bank = {
									...
									desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_RESTACK_TEXT"], ArkInventory.Global.Location[ArkInventory.Const.Location.Bank].Name ),
									type = "toggle",
									get = function( info )
								...
								vault = {
									...
									name = ArkInventory.Global.Location[ArkInventory.Const.Location.Vault].Name,
									disabled = not ArkInventory.ClientCheck( ArkInventory.Global.Location[ArkInventory.Const.Location.Vault].proj ),
									desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_RESTACK_TEXT"], ArkInventory.Global.Location[ArkInventory.Const.Location.Vault].Name ),
									type = "toggle",
									get = function( info )
										if ArkInventory.ClientCheck( ArkInventory.Global.Location[ArkInventory.Const.Location.Vault].proj ) then
						...
						rules = {
							...
							args = {
								state = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_RULES_STATE_TEXT"],
									type = "toggle",
									get = function( info )
						...
						crossrealm = {
							...
							args = {
								state = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_CROSSREALM_LOADED_TEXT"],
									type = "toggle",
									get = function( info )
...
function ArkInventory.ConfigInternalSortMethodData( path )
	...
	local args3 = {
		...
		descending = {
			...
			desc = function( info )
				local key = ConfigGetNodeArg( info, #info - 1 )
				return string.format( ArkInventory.Localise["CONFIG_SORTING_DIRECTION_TEXT"], string.format( "%s%s%s", LIGHTYELLOW_FONT_COLOR_CODE, ArkInventory.Localise[string.upper( string.format( "CONFIG_SORTING_INCLUDE_%s", key ) )], FONT_COLOR_CODE_CLOSE ) )
			end,
			type = "toggle",
			hidden = function( info )
				local id = ConfigGetNodeArg( info, #info - 3 )
	...
	local args1 = {
		action_name = {
			...
			desc = string.format( ArkInventory.Localise["CONFIG_LIST_NAME_TEXT"], ArkInventory.Localise["CONFIG_SORTING_METHOD"] ),
			type = "input",
			width = "double",
			disabled = function( info )
...
function ArkInventory.ConfigInternalCategoryCustomData( path )
	...
	local args1 = {
		...
		action_name = { 
			order = 100,
			name = ArkInventory.Localise["NAME"],
			desc = string.format( ArkInventory.Localise["CONFIG_LIST_NAME_TEXT"], ArkInventory.Localise["CONFIG_CATEGORY_CUSTOM"] ),
			type = "input",
			width = "double",
			disabled = function( info )
				local id = ConfigGetNodeArg( info, #info - 1 )
...
function ArkInventory.ConfigInternalCategoryRuleData( path )
	...
	local args1 = {
		action_name = { 
			order = 100,
			name = ArkInventory.Localise["NAME"],
			desc = string.format( ArkInventory.Localise["CONFIG_LIST_NAME_TEXT"], ArkInventory.Localise["CATEGORY_RULE"] ),
			type = "input",
			width = "double",
			disabled = function( info )
				local id = ConfigGetNodeArg( info, #info - 1 )
...
function ArkInventory.ConfigInternalCategorysetData( path )
	...
	local args1 = {
		...
		action_name = { 
			order = 100,
			name = ArkInventory.Localise["NAME"],
			desc = string.format( ArkInventory.Localise["CONFIG_LIST_NAME_TEXT"], ArkInventory.Localise["CONFIG_CATEGORY_SET"] ),
			type = "input",
			width = "double",
			disabled = function( info )
				local id = ConfigGetNodeArg( info, #info - 1 )
...
function ArkInventory.ConfigInternalDesignData( path )
		...
		if not v.hide then
			...
			if ArkInventory.ClientCheck( v.proj ) then
				...
				args2[string.format( "%i", k )] = {
					...
					desc = function( )
						return string.format( ArkInventory.Localise["CONFIG_DESIGN_ITEM_EMPTY_COLOUR_TEXT"], ArkInventory.Const.Slot.Data[k].name )
					end,
					type = "color",
					hasAlpha = false,
					hidden = false,
	...
	local args1 = {
		...
		action_name = {
			order = 100,
			name = ArkInventory.Localise["NAME"],
			desc = string.format( ArkInventory.Localise["CONFIG_LIST_NAME_TEXT"], ArkInventory.Localise["CONFIG_DESIGN"] ),
			type = "input",
			width = "double",
			disabled = function( info )
				local id = ConfigGetNodeArg( info, #info - 1 )
						...
						border = {
							...
							args = {
								...
								rarity = {
									...
									desc = ArkInventory.Localise["CONFIG_DESIGN_ITEM_BORDER_QUALITY_TEXT"],
									type = "toggle",
									disabled = function( info )
										local id = ConfigGetNodeArg( info, #info - 4 )
										local style = ArkInventory.ConfigInternalDesignGet( id )
								...
								raritycutoff = {
									...
									desc = function( info )
										local id = ConfigGetNodeArg( info, #info - 4 )
										local style = ArkInventory.ConfigInternalDesignGet( id )
										return string.format( ArkInventory.Localise["CONFIG_DESIGN_ITEM_BORDER_QUALITY_CUTOFF_TEXT"], ( select( 5, ArkInventory.GetItemQualityColor( style.slot.border.raritycutoff ) ) ), _G[string.format( "ITEM_QUALITY%d_DESC", style.slot.border.raritycutoff or LE_ITEM_QUALITY_POOR )] )
									end,
									type = "select",
									disabled = function( info )
										local id = ConfigGetNodeArg( info, #info - 4 )
						...
						itemlevel = {
							...
							args = {
								...
								quality = {
									order = 250,
									name = ArkInventory.Localise["QUALITY"],
									desc = ArkInventory.Localise["CONFIG_DESIGN_ITEM_ITEMLEVEL_QUALITY_TEXT"],
									type = "toggle",
									disabled = function( info )
										local id = ConfigGetNodeArg( info, #info - 4 )
										local style = ArkInventory.ConfigInternalDesignGet( id )
								...
								azerite = {
									...
									args = {
										show = {
											order = 10,
											name = ArkInventory.Localise["ENABLED"],
											desc = string.format( ArkInventory.Localise["CONFIG_DESIGN_ITEM_OVERLAY_TEXT"], ArkInventory.Localise["CONFIG_DESIGN_ITEM_OVERLAY_AZERITE"] ),
											type = "toggle",
											get = function( info )
												local id = ConfigGetNodeArg( info, #info - 5 )
												local style = ArkInventory.ConfigInternalDesignGet( id )
								...
								nzoth = {
									...
									args = {
										show = {
											order = 10,
											name = ArkInventory.Localise["ENABLED"],
											desc = string.format( ArkInventory.Localise["CONFIG_DESIGN_ITEM_OVERLAY_TEXT"], ArkInventory.Localise["CONFIG_DESIGN_ITEM_OVERLAY_NZOTH"] ),
											type = "toggle",
											get = function( info )
												local id = ConfigGetNodeArg( info, #info - 5 )
												local style = ArkInventory.ConfigInternalDesignGet( id )
...
function ArkInventory.ConfigInternalProfile( )
	...
	local me = ArkInventory.GetPlayerCodex( )
	config.profile.current = me.player.data.profile
...
function ArkInventory.ConfigInternalProfileData( path )
	...
	local args1 = {
		action_name = {
			order = 100,
			name = ArkInventory.Localise["NAME"],
			desc = string.format( ArkInventory.Localise["CONFIG_LIST_NAME_TEXT"], ArkInventory.Localise["CONFIG_PROFILE"] ),
			type = "input",
			width = "double",
			disabled = function( info )
				local id = ConfigGetNodeArg( info, #info - 1 )
		...
		action_activate = {
			...
			desc = function( info )
				return string.format( ArkInventory.Localise["CONFIG_LIST_ACTIVATE_TEXT"], ArkInventory.Localise["CONFIG_PROFILE"] )
			end,
			type = "execute",
			width = "half",
			...
			disabled = function( info )
				local id = ConfigGetNodeArg( info, #info - 1 )
				--local me = ArkInventory.GetPlayerCodex( )
				--if id == me.player.data.profile then
...
function ArkInventory.ConfigInternalAccount( )
	...
	path.args = {
		list_add = {
			order = 100,
			name = ArkInventory.Localise["ADD"],
			desc = string.format( ArkInventory.Localise["CONFIG_LIST_ADD_TEXT"], ArkInventory.Localise["ACCOUNT"] ),
			type = "input",
			width = "double",
...
function ArkInventory.ConfigInternalAccountData( path )
	...
	local args1 = {
		...
		action_name = { 
			order = 100,
			name = ArkInventory.Localise["NAME"],
			desc = string.format( ArkInventory.Localise["CONFIG_LIST_NAME_TEXT"], ArkInventory.Localise["ACCOUNT"] ),
			type = "input",
			width = "double",
			disabled = function( info )
				local id = ConfigGetNodeArg( info, #info - 1 )
		...
		action_delete = { 
			...
			name = ArkInventory.Localise["DELETE"],
			desc = function( info )
				return string.format( ArkInventory.Localise["CONFIG_LIST_DELETE_TEXT"], ArkInventory.Localise["ACCOUNT"] )
			end,
			type = "execute",
			width = "half",
		...
		action_restore = { 
			...
			name = ArkInventory.Localise["RESTORE"],
			desc = function( info )
				return string.format( ArkInventory.Localise["CONFIG_LIST_RESTORE_TEXT"], ArkInventory.Localise["ACCOUNT"] )
			end,
			type = "execute",
			width = "half",
		...
		action_purge = {
			order = 400,
			name = ArkInventory.Localise["PURGE"],
			desc = string.format( ArkInventory.Localise["CONFIG_LIST_PURGE_TEXT"], ArkInventory.Localise["ACCOUNT"] ),
			type = "execute",
			width = "half",
			hidden = config.account.show ~= 2,
			func = function( info )
	...
	local args2 = {
		action_erase_location = { 
			...
			desc = function( info )
				...
				return string.format( "%s%s", RED_FONT_COLOR_CODE, string.format( ArkInventory.Localise["MENU_CHARACTER_SWITCH_ERASE_TEXT"], ArkInventory.Global.Location[loc_id].Name, ArkInventory.DisplayName1( info ) ) )
			end,
			hidden = false,
			type = "execute",
			func = function( info )
	...
	local args1 = {
		action_erase_all = { 
			...
			desc = function( info )
				...
				local info = ArkInventory.GetPlayerInfo( player_id )
				return string.format( "%s%s", RED_FONT_COLOR_CODE, string.format( ArkInventory.Localise["MENU_CHARACTER_SWITCH_ERASE_TEXT"], ArkInventory.Localise["ALL"], ArkInventory.DisplayName1( info ) ) )
			end,
			type = "execute",
			hidden = false,
			func = function( info )
