...
$Revision: 2597 $
$Date: 2020-06-14 14:28:32 +1000 (Sun, 14 Jun 2020) $
...
ArkInventory.Const.Category = {
	...
	Code = {
		System = { -- do NOT change the indicies - if you have to then see the DatabaseUpgradePostLoad( ) function to remap it
			...
			[421] = {
				proj = ArkInventory.ClientSet( WOW_PROJECT_CLASSIC ),
...
--			[422] = { SYSTEM_PROJECTILE_BULLET }
			...
			[441] = {
				proj = ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ),
...
function ArkInventory.TOCVersionFail( quiet )
	...
	if not ArkInventory.Const.Blizzard.Client.Data[WOW_PROJECT_ID] then
		if not quiet then
			ArkInventory.Output( ArkInventory.Global.Version, " ", ArkInventory.Localise["DISABLED"], " - Unsupported WOW_PROJECT_ID=", WOW_PROJECT_ID, "." )
			ArkInventory:Disable( )
		end
		return true
	end
	
	if ArkInventory.Const.TOC < ArkInventory.Const.Blizzard.Client.Data[WOW_PROJECT_ID].TOC then
		if not quiet then
			ArkInventory.Output( ArkInventory.Global.Version, " ", ArkInventory.Localise["DISABLED"], " - Requires an Alpha, Beta, or PTR, Server." )
			ArkInventory:Disable( )
		end
		return true
	end
...
function ArkInventory.OnLoad( )
	...
	ArkInventory.Global.Version = string.format( "%s [%s]", ArkInventory.Global.Version, ArkInventory.Const.Blizzard.Client.Data[WOW_PROJECT_ID].Name )
...
--		{ "UNIT_POWER", "EVENT_ARKINV_UNIT_POWER" },
		{ "ACTIVE_TALENT_GROUP_CHANGED", "EVENT_ARKINV_TALENT_CHANGED", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "UI_SCALE_CHANGED", "" },
		
		{ "AUCTION_HOUSE_SHOW", "EVENT_ARKINV_AUCTION_ENTER" },
		{ "AUCTION_HOUSE_CLOSED", "EVENT_ARKINV_AUCTION_LEAVE" },
		{ "AUCTION_OWNED_LIST_UPDATE", "EVENT_ARKINV_AUCTION_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ), nil, 80205 },
		{ "AUCTION_OWNED_LIST_UPDATE", "EVENT_ARKINV_AUCTION_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_CLASSIC ) },
		{ "OWNED_AUCTIONS_UPDATED", "EVENT_ARKINV_AUCTION_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ), 80300 },
--		{ "OWNED_AUCTION_EXPIRED", "EVENT_ARKINV_AUCTION_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "OWNED_AUCTION_ADDED", "EVENT_ARKINV_AUCTION_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "AUCTION_CANCELED", "EVENT_ARKINV_AUCTION_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ), 80300 },
		
		{ "UNIT_INVENTORY_CHANGED", "EVENT_ARKINV_INVENTORY_CHANGE" },
		
		{ "EQUIPMENT_SETS_CHANGED", "EVENT_ARKINV_EQUIPMENT_SETS_CHANGED", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
...
--		{ "BANK_BAG_SLOT_FLAGS_UPDATED", "EVENT_ARKINV_BANK_UPDATE" },
		...
		{ "REAGENTBANK_PURCHASED", "EVENT_ARKINV_BANK_TAB", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) }, -- triggered when you purchase a bank tab (reagent bank)
		{ "REAGENTBANK_UPDATE", "EVENT_ARKINV_REAGENTBANK_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PLAYERREAGENTBANKSLOTS_CHANGED", "EVENT_ARKINV_REAGENTBANK_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) }, -- a bag_update event for the reagent bank (-3)
		
		{ "GUILDBANKBAGSLOTS_CHANGED", "EVENT_ARKINV_VAULT_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "GUILDBANKFRAME_CLOSED", "EVENT_ARKINV_VAULT_LEAVE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "GUILDBANKFRAME_OPENED", "EVENT_ARKINV_VAULT_ENTER", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "GUILDBANKLOG_UPDATE", "EVENT_ARKINV_VAULT_LOG", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "GUILDBANK_ITEM_LOCK_CHANGED", "EVENT_ARKINV_VAULT_LOCK", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "GUILDBANK_UPDATE_MONEY", "EVENT_ARKINV_VAULT_MONEY", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "GUILDBANK_UPDATE_TABS", "EVENT_ARKINV_VAULT_TABS", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "GUILDBANK_UPDATE_TEXT", "EVENT_ARKINV_VAULT_INFO", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		
		{ "HEIRLOOMS_UPDATED", "EVENT_ARKINV_COLLECTION_HEIRLOOM_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		
		{ "CURRENCY_DISPLAY_UPDATE", "EVENT_ARKINV_COLLECTION_CURRENCY_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PLAYER_TRADE_CURRENCY", "EVENT_ARKINV_COLLECTION_CURRENCY_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		...
		{ "MOUNT_EQUIPMENT_APPLY_RESULT", "EVENT_ARKINV_COLLECTION_MOUNT_EQUIPMENT_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "MOUNT_JOURNAL_SEARCH_UPDATED", "" },
--		{ "MOUNT_JOURNAL_USABILITY_CHANGED", "" },
		{ "NEW_MOUNT_ADDED", "EVENT_ARKINV_COLLECTION_MOUNT_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
...
--		{ "CHAT_MSG_PET_INFO", "EVENT_ARKINV_COLLECTION_PET_UPDATE" },
		{ "COMPANION_LEARNED", "EVENT_ARKINV_COLLECTION_MOUNT_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "COMPANION_UNLEARNED", "EVENT_ARKINV_COLLECTION_MOUNT_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "COMPANION_UPDATE", "EVENT_ARKINV_COLLECTION_MOUNT_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) }, -- do i really need this? it triggers when other people mount/dismount as well
		{ "NEW_PET_ADDED", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PET_BATTLE_CLOSE", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PET_BATTLE_LEVEL_CHANGED", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PET_BATTLE_OPENING_DONE", "EVENT_ARKINV_BATTLEPET_OPENING_DONE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "PET_BATTLE_OVER", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "PET_BATTLE_PET_CHANGED", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "PET_BATTLE_PET_ROUND_RESULTS", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PET_BATTLE_QUEUE_STATUS", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "PET_BATTLE_XP_CHANGED", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PET_JOURNAL_LIST_UPDATE", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PET_JOURNAL_PET_DELETED", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PET_JOURNAL_PET_RESTORED", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PET_JOURNAL_PET_REVOKED", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "PET_JOURNAL_PETS_HEALED", "EVENT_ARKINV_COLLECTION_PET_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		
--		{ "OBLITERUM_FORGE_CLOSE", "", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "OBLITERUM_FORGE_SHOW", "", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
...
--		{ "QUEST_LOG_UPDATE", "" }, -- triggers too often to be usable
		...
		{ "WORLD_QUEST_COMPLETED_BY_SPELL", "EVENT_ARKINV_QUEST_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		
		{ "SCRAPPING_MACHINE_CLOSE", "EVENT_ARKINV_SCRAP_LEAVE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "SCRAPPING_MACHINE_SHOW", "EVENT_ARKINV_SCRAP_ENTER", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		
		{ "TRADE_CLOSED", "EVENT_ARKINV_TRADE_LEAVE" },
		{ "TRADE_SHOW", "EVENT_ARKINV_TRADE_ENTER" },
		
		{ "TRANSMOGRIFY_CLOSE", "EVENT_ARKINV_TRANSMOG_LEAVE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "TRANSMOGRIFY_OPEN", "EVENT_ARKINV_TRANSMOG_ENTER", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		
		{ "NEW_TOY_ADDED", "EVENT_ARKINV_COLLECTION_TOYBOX_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "TOYS_UPDATED", "EVENT_ARKINV_COLLECTION_TOYBOX_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
...
--		{ "UPDATE_FACTION", "EVENT_ARKINV_COLLECTION_REPUTATION_UPDATE" }, -- triggers off gui changes and can cause infinite loops if another mod changes the gui
		...
		{ "LFG_BONUS_FACTION_ID_UPDATED", "EVENT_ARKINV_COLLECTION_REPUTATION_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		
--		{ "VOID_DEPOSIT_WARNING", "EVENT_ARKINV_VOID_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "VOID_STORAGE_CONTENTS_UPDATE", "EVENT_ARKINV_VOID_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "VOID_STORAGE_DEPOSIT_UPDATE", "EVENT_ARKINV_VOID_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "VOID_STORAGE_UPDATE", "EVENT_ARKINV_VOID_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
		{ "VOID_TRANSFER_DONE", "EVENT_ARKINV_VOID_UPDATE", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) },
--		{ "VOID_STORAGE_OPEN", "", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) }, -- not used, we dont override the void
--		{ "VOID_STORAGE_CLOSE", "", ArkInventory.ClientSet( WOW_PROJECT_MAINLINE ) }, -- not used, we dont override the void
...
function ArkInventory.OnEnable( )
	...
	if ArkInventory.ClientCheck( WOW_PROJECT_CLASSIC ) then
		...
		ArkInventory.db.option.tooltip.battlepet.mouseover.enable = false
	end
...
--	ArkInventory:RegisterBucketMessage( "EVENT_ARKINV_ZONE_CHANGED_BUCKET", 5 )
	...
	for k, v in pairs( ArkInventory.Const.Blizzard.Events ) do
		...
		if v[1] and v[1] ~= "" then
			...
			if v[2] and v[2] ~= "" and ArkInventory[v[2]] then
				-- 3 = project id
				if ArkInventory.ClientCheck( v[3] ) then
					-- 4 = min/max toc required
					if ( not v[4] or v[4] <= ArkInventory.Const.TOC ) and ( not v[5] or v[5] >= ArkInventory.Const.TOC ) then
	...
	ArkInventory.ClientSetSortBagsRightToLeft( ArkInventory.db.option.restack.reverse )
	...
	if sorting.used then
		...
		if i.h and info.class == "item" then
			if type( info.equiploc ) == "string" and info.equiploc ~= "" and _G[info.equiploc] then
				s.location = _G[info.equiploc]
			end
		end
		s.location = s.location or ""
...
function ArkInventory.ItemCategoryGetDefaultActual( i )
	...
	if ArkInventory.ClientIsArtifactPowerItem( info.id ) or ArkInventory.PT_ItemInSets( i.h, "ArkInventory.Consumable.Artifact Power" ) then
	...
	if info.itemtypeid == ArkInventory.Const.ItemClass.CONSUMABLE and ArkInventory.ClientCheck( WOW_PROJECT_MAINLINE ) then
	...
	if info.itemtypeid == ArkInventory.Const.ItemClass.TRADEGOODS and ArkInventory.ClientCheck( WOW_PROJECT_MAINLINE ) then
	...
	if ArkInventory.TooltipContains( ArkInventory.Global.Tooltip.Scan, ITEM_TOY_ONUSE, false, true, true, true ) then
		if ArkInventory.IsBound( i.sb ) and ArkInventory.TooltipContains( ArkInventory.Global.Tooltip.Scan, ArkInventory.Localise["ALREADY_KNOWN"], false, true, true, true ) then
			return ArkInventory.CategoryGetSystemID( "SYSTEM_TRASH" )
		else
			return ArkInventory.CategoryGetSystemID( "SYSTEM_TOY" )
		end
	...
	-- soulbound known recipes = trash
	if info.itemtypeid == ArkInventory.Const.ItemClass.RECIPE and ArkInventory.IsBound( i.sb ) and ArkInventory.TooltipContains( ArkInventory.Global.Tooltip.Scan, ArkInventory.Localise["ALREADY_KNOWN"], false, true, true, true ) then
		return ArkInventory.CategoryGetSystemID( "SYSTEM_TRASH" )
	end
	...
	if codex.player.data.priority.profession > 0 then
		...
		for x = 1, ArkInventory.Const.Skills.numPrimary do
			...
			if codex.player.data.info.skills[x] then
				...
				if skill and codex.player.data.priority.profession == x then
...
--			end
	...
	-- reputation
	if ArkInventory.PT_ItemInSets( i.h, "ArkInventory.System.Reputation" ) then
		return ArkInventory.CategoryGetSystemID( "SYSTEM_REPUTATION" )
	end
...
function ArkInventory.Frame_Bar_Label_OLD( frame )
...
--	ArkInventory.Output( "bar - on drag start: ", loc_id, ".", bar_id )
	...
	ArkInventory.EditModeOnDrag( ArkInventory.Const.Move.Bar, frame )
...
function ArkInventory.Frame_Bar_Edit_OnDragReceive( frame )
	...
	-- move bar
	if ArkInventory.Global.Options.OnDragType == ArkInventory.Const.Move.Bar then
		
		if ArkInventory.Global.Options.OnDragLocation and ArkInventory.Global.Options.OnDragSourceBar then
	...
	-- move category
	if ArkInventory.Global.Options.OnDragType == ArkInventory.Const.Move.Category then
		
		if ArkInventory.Global.Options.OnDragLocation and ArkInventory.Global.Options.OnDragSourceBar and ArkInventory.Global.Options.OnDragSourceData then

			if ArkInventory.Global.Options.OnDragLocation == loc_id and ArkInventory.Global.Options.OnDragSourceBar ~= bar_id then
				
				ArkInventory.CategoryLocationSet( loc_id, ArkInventory.Global.Options.OnDragSourceData, bar_id )
...
function ArkInventory.Frame_Bar_Edit_OnEnter( frame )
	ArkInventory.GameTooltipSetText( frame, string.format( ArkInventory.Localise["MENU_BAR_TITLE"], frame:GetID( ) ) )
end
...
function ArkInventory.Frame_Item_Update_Quest( frame, codex )
	...
	if ( loc_id == ArkInventory.Const.Location.Bag or loc_id == ArkInventory.Const.Location.Bank ) and not ArkInventory.Global.Location[loc_id].isOffline then
		...
		if i and i.h then
			...
			local isQuestItem, questId, isActive = ArkInventory.ClientGetContainerItemQuestInfo( frame.ARK_Data.blizzard_id, frame.ARK_Data.slot_id, i )
...
function ArkInventory.Frame_Item_Update_StatusIconUpgrade( frame, codex )
	...
	if not ArkInventory.ClientCheck( WOW_PROJECT_MAINLINE ) then return end
...
function ArkInventory.Frame_Item_Update_StatusIconOverlay( frame, codex )
	...
	if i and i.h then
		...
		if codex.style.slot.overlay.nzoth.show and ArkInventory.ClientIsCorruptedItem( i.h ) then
...
function ArkInventory.Frame_Item_OnEnter( frame )
	...
	if i and i.h then
		...
		elseif loc_id == ArkInventory.Const.Location.Pet then
			...
			ArkInventory.TooltipBattlepetShow( GameTooltip, i.h, i )
			CursorUpdate( frame )
			return
			...
			if frame.ARK_Data.loc_id == ArkInventory.Const.Location.Bag then
				if button == "RightButton" and not IsModifiedClick( ) then
					...
					if itemID then
						...
						if ArkInventory.ClientIsReagentBankUnlocked( ) and GetContainerNumFreeSlots( REAGENTBANK_CONTAINER ) > 0 then
...
--		local bar_id = ArkInventory.CategoryLocationGet( loc_id, cat_id )
		...
		ArkInventory.EditModeOnDrag( ArkInventory.Const.Move.Category, frame )
		
--		ArkInventory.Output( "item - on drag start: bar=", bar_id, " category=", cat_id )
...
function ArkInventory.Frame_Item_OnDragReceive( frame )
	...
	if ArkInventory.Global.Mode.Edit then
		...
		if ArkInventory.Global.Options.OnDragType == ArkInventory.Const.Move.Bar then
			...
			if ArkInventory.Global.Options.OnDragLocation and ArkInventory.Global.Options.OnDragSourceBar then
				...
				if ArkInventory.Global.Options.OnDragLocation == loc_id and ArkInventory.Global.Options.OnDragSourceBar ~= bar_id then
					...
					--ArkInventory.Output( "moving bar ", ArkInventory.Global.Options.OnDragLocation, ".", ArkInventory.Global.Options.OnDragSourceBar, " to ", loc_id, ".", bar_id )
		...
		if ArkInventory.Global.Options.OnDragType == ArkInventory.Const.Move.Category then
			...
			--ArkInventory.Output( "moving category: ", ArkInventory.Global.Options.OnDragLocation, ".", ArkInventory.Global.Options.OnDragSourceBar, " / ", ArkInventory.Global.Options.OnDragSourceData )
			
			if ArkInventory.Global.Options.OnDragLocation and ArkInventory.Global.Options.OnDragSourceBar and ArkInventory.Global.Options.OnDragSourceData then
				
				--ArkInventory.Output( "valid data" )
				
				if IsAltKeyDown( ) then
					
					-- set category for dragged item to match destination items category, if its a custom category
					
					local cat_type, cat_code = ArkInventory.CategoryCodeSplit( cat_id )
					if cat_type == ArkInventory.Const.Category.Type.Custom then
						
						local si = ArkInventory.Frame_Item_GetDB( ArkInventory.Global.Options.OnDragSourceFrame )
						local sloc_id = i.loc_id
						local scat_id = ArkInventory.ItemCategoryGet( si )
						local sbar_id = ArkInventory.CategoryLocationGet( sloc_id, scat_id )
						
						if scat_id ~= cat_id then
							
							ArkInventory.Output( "assign item ", si.h, " to category ", cat_id )
							
							--ArkInventory.ItemCategorySet( si, cat_id )
							
							ArkInventory.Frame_Main_Generate( nil, ArkInventory.Const.Window.Draw.Recalculate )
							
						else
							ArkInventory.OutputWarning( "category assignment aborted, item is already assigned to the same category" )
						end
						
					else
						ArkInventory.OutputWarning( "category assignment aborted, the destination item is not assigned to a custom category" )
					end
					...
					if ArkInventory.Global.Options.OnDragLocation == loc_id and ArkInventory.Global.Options.OnDragSourceBar ~= bar_id then
						...
						--ArkInventory.Output( "moving category ", ArkInventory.Global.Options.OnDragSourceData, "from bar ", ArkInventory.Global.Options.OnDragSourceBar, " to bar ", bar_id )
...
function ArkInventory.HookFloatingBattlePet_Show( ... )
	...
	if ItemRefTooltip:IsShown( ) and ItemRefTooltip.ARKTTD[1] == h then
		...
		ArkInventory.TooltipBattlepetShow( ItemRefTooltip, h )
	end
				...
				for func, proj in pairs( ArkInventory.Const.Blizzard.TooltipFunctions ) do
					if ArkInventory.ClientCheck( proj ) then
						...
						if obj[func] and ArkInventory[myfunc] then	
							...
							--ArkInventory.Output( "GameTooltip:", func, " secure hooked" )
						else
...
function ArkInventory.GameTooltipSetHyperlink( frame, h )
	...
	if osd.class == "battlepet" then
		...
		ArkInventory.TooltipBattlepetShow( GameTooltip, h )
...
function ArkInventory.EditModeOnDrag( dragtype, frame )
	...
	ArkInventory.Global.Options.OnDragSourceData = cat_id
