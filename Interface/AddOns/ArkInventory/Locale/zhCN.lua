...
--	L["CONFIG_SORTING_WHEN_MANUAL_TEXT"] = ""
	...
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ENABLE_TEXT"] = "设定提示中是否显示物品数量"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_CLASS_TEXT"] = "使用职业颜色显示玩家名称"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT_TEXT"] = "设定物品数量文字颜色"
...
--	L["CONFIG_DESIGN_ITEM_COOLDOWN_SHOW_TEXT"] = "显示 %1$s 窗口中的物品冷却"
	...
	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_TEXT"] = "物品边框是否按照稀有度进行着色"
	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_CUTOFF"] = "稀有度界线"
	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_CUTOFF_TEXT"] = "只对稀有度不低于 %s 的物品边框进行染色"
