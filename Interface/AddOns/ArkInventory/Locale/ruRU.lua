...
--	L["CONFIG_SORTING_WHEN_MANUAL_TEXT"] = ""
	...
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ENABLE_TEXT"] = "показывать ли количество предметов в тултипе?"
--	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_CLASS_TEXT"] = ""
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT_TEXT"] = "задает цвет текста для количества предметов."
...
--	L["CONFIG_DESIGN_ITEM_BORDER_STYLE_TEXT"] = ""
	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_TEXT"] = "окрашивать ли кромку каждой ячейки в соответствии с качеством вещи"
