...
--	item menu
	...
	L["MENU_ITEM_ITEMCOUNT_TEXT"] = "Display item counts in tooltips for this item."
	L["MENU_ITEM_ITEMCOUNT_STATUS_TEXT"] = "%s\n\nclick to %s it."
...
--	configuration options > system
	...
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD_TEXT"] = "add an empty line between the basic tooltip text and any custom text to be added"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT"] = "Item Count"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ENABLE_TEXT"] = "include item counts in tooltips"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_CLASS_TEXT"] = "use class colours to colour player names"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT_TEXT"] = "set the colour of the item count tooltip text"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_AMOUNTS_TEXT"] = "set the colour of the item count amounts"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_VAULT_TABS_TEXT"] = "include tab numbers for items found in a %1$s" -- %1$s = vault
	L["CONFIG_GENERAL_TOOLTIP_MONEY_ENABLE_TEXT"] = "include money amounts in tooltips"
	L["CONFIG_GENERAL_TOOLTIP_MONEY_COLOUR_CLASS_TEXT"] = "use class colours to colour player names"
	L["CONFIG_GENERAL_TOOLTIP_MONEY_COLOUR_TEXT_TEXT"] = "set the colour of the money tooltip text"
	L["CONFIG_GENERAL_TOOLTIP_MONEY_COLOUR_AMOUNTS_TEXT"] = "set the colour of the money amounts"
	...
	L["CONFIG_GENERAL_TOOLTIP_ACCOUNT_ONLY_TEXT"] = "display data only for the current characters account"
	...
	L["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_TEXT"] = "the number of milliseconds before the code will yield so it doesnt hit the script timer limit when %1$s"
	...
	L["CONFIG_GENERAL_MESSAGES_RESTACK_TEXT"] = "Show restack notification messages for the %1$s"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION"] = "Translation"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_INTERIM"] = "Interim"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_INTERIM_TEXT"] = "Show a message for each translation attempt"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_FINAL"] = "Final"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_FINAL_TEXT"] = "Show a message for the final/successful translation"
	...
	L["CONFIG_GENERAL_MESSAGES_RULES_STATE_TEXT"] = "Show a message when rules are enabled/disabled"
	L["CONFIG_GENERAL_MESSAGES_RULES_HOOKED"] = "Hooks"
	L["CONFIG_GENERAL_MESSAGES_RULES_HOOKED_TEXT"] = "Show a message when a third party mod is loaded/hooked"
	L["CONFIG_GENERAL_MESSAGES_RULES_REGISTRATION"] = "Registration"
	L["CONFIG_GENERAL_MESSAGES_RULES_REGISTRATION_TEXT"] = "Show a message for each third party rule registration"
	L["CONFIG_GENERAL_MESSAGES_CROSSREALM_LOADED"] = "Loaded"
	L["CONFIG_GENERAL_MESSAGES_CROSSREALM_LOADED_TEXT"] = "Show a message when connected realm data is loaded"
	...
	L["CONFIG_GENERAL_PROFESSION_PRIORITY"] = "Priority"
	L["CONFIG_GENERAL_PROFESSION_PRIORITY_TEXT"] = "Select which profession you want items categorised for first.\n\nThis is set/saved per character and will save the slot the profession is in, not the actual profession."
	
	L["CONFIG_GENERAL_BONUSID"] = "Bonus IDs"
	L["CONFIG_GENERAL_BONUSID_COUNT"] = "Item Count"
	L["CONFIG_GENERAL_BONUSID_SUFFIX"] = "Item Suffix"
	L["CONFIG_GENERAL_BONUSID_SUFFIX_COUNT_TEXT"] = "Enabled: Generates a count for each item suffix found\n\nDisabled: Ignores any item suffix and generates a count for the base item instead"
	L["CONFIG_GENERAL_BONUSID_SEARCH"] = "Item Search"
	L["CONFIG_GENERAL_BONUSID_SUFFIX_SEARCH_TEXT"] = "Enabled: Searches against the item with its suffix\n\nDisabled: Ignores any item suffix and searches against the base item instead"
	L["CONFIG_GENERAL_BONUSID_CORRUPTION"] = "Corruption"
	L["CONFIG_GENERAL_BONUSID_CORRUPTION_SEARCH_TEXT"] = "Enabled: Searches against the item with its corruption\n\nDisabled: Ignores any item corruption and searches against the base item instead"
...
--	configuration settings > design/style/layout
	...
	L["CONFIG_DESIGN_ITEM_ITEMLEVEL_QUALITY_TEXT"] = "use the items quality colour for the item text"
	...
	L["CONFIG_DESIGN_ITEM_OVERLAY_TEXT"] = "Enabled: Use the %1$s item overlay when required.\n\nDisabled: Do not use the %1$s item overlay."
	...
	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_TEXT"] = "colour the border around each item to match it's quality (Common, Rare, Epic, etc)"
	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_CUTOFF"] = "Quality Cutoff"
	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_CUTOFF_TEXT"] = "only colour the item border if the item quality is equal to or above: %s%s|r"
...
-- junk
	...
	L["CONFIG_JUNK_QUALITY_CUTOFF_TEXT"] = "Only sell/destroy an item if its quality is at or below: %s%s|r"
...
-- sorting
	...
	L["CONFIG_SORTING_INCLUDE_QUALITY_TEXT"] = "include item quality when sorting"
	...
	L["CONFIG_SORTING_INCLUDE_BAGID_TEXT"] = "include bag id when sorting."
	L["CONFIG_SORTING_INCLUDE_SLOTID"] = "slot id"
	L["CONFIG_SORTING_INCLUDE_SLOTID_TEXT"] = "include slot id when sorting."
	L["CONFIG_SORTING_INCLUDE_COUNT"] = "item count"
	L["CONFIG_SORTING_INCLUDE_COUNT_TEXT"] = "include item count when sorting."
	
	L["CONFIG_SORTING_DIRECTION_TEXT"] = "if this is ticked then %1$s will be sorted in descending order\n\nif this is not ticked %1$s will be sorted in ascending order"
	...
	L["CONFIG_LIST_ACTIVATE_TEXT"] = "make this the active %1$s"
	L["CONFIG_LIST_DELETE_TEXT"] = "delete this %1$s"
	L["CONFIG_LIST_RESTORE_TEXT"] = "restore this deleted %1$s"
	L["CONFIG_LIST_NAME_TEXT"] = "set the name for this %1$s"
